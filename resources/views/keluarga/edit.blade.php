...
<!--start breadcrumb-->
    ...
    <div class="card">
        <div class="card-header">
            <h6 class="mb-0">Edit Keluarga</h6>
        </div>
        <div class="card-body">
            @if(session('status'))
            ...
            @method('PUT')
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="dkb" value="{{ $keluarga->dkb }}" 
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="tahun" value="{{ $keluarga->tahun }}" 
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="kecamatans_id" value="{{ $keluarga->kecamatans_id }}" 
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="desas_id" value="{{ $keluarga->desas_id }}" 
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="agama" value="{{ $keluarga->agama }}" 
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="disabilitas" value="{{ $keluarga->disabilitas }}" 
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="golongan_darah" value="{{ $keluarga->golongan_darah }}" 
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="kepemilikan_kk" value="{{ $keluarga->kepemilikan_kk }}" 
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="pekerjaan" value="{{ $keluarga->pekerjaan }}" 
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="pendidikan" value="{{ $keluarga->pendidikan }}" 
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="status_kawin" value="{{ $keluarga->status_kawin }}" 
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="umur_tunggal" value="{{ $keluarga->umur_tunggal }}" 
